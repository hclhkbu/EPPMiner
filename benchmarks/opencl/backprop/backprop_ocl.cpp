...
int bpnn_train_kernel(BPNN *net, float *eo, float *eh)
{
	...
	double averMsecs_1 = total_s / nIter * 1000;
	printf("kernel1(): iterated %d times, aver time is %lf ms.\n", nIter, averMsecs_1);
	...
	double averMsecs_2 = total_s / nIter * 1000;
	printf("kernel2() iterated %d times, aver time is %lf ms.\n", nIter, averMsecs_2);
