...
{   
	int rows, cols, size_I, size_R, niter = 100, iter, k;
	...
	in(I,J,c:length(size_I))  \
	in(iN,iS:length(rows))   \
	in(jW,jE:length(cols))   \
	out(dN,dS,dW,dE:length(size_I))  \
	in(iteration,cN,cS,cW,cE,D,lambda,niter,r1,r2,c1,c2,rows,cols,size_I,size_R,Jc,G2,L,num,den,qsqr)
	{
